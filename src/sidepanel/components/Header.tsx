...
export function Header({ title, headerRight }: HeaderProps) {
  return (
    <header className="sticky top-0 z-50 h-14 w-full flex items-center justify-between px-4 border-b border-slate-200 bg-white/80 backdrop-blur-md shrink-0">
